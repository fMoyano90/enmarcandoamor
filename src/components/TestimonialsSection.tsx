    ...
    <section id="testimonios" className="py-20 bg-amor-verde-oscuro/5">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-4xl font-bold text-amor-verde-oscuro mb-4">
            Lo Que Dicen Nuestros Clientes
          </h2>
          <p className="text-amor-gris max-w-2xl mx-auto">
            Nos enorgullece ver cómo nuestros cuadros se convierten en parte
            importante de los recuerdos de nuestros clientes.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto relative">
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-amor-gris italic mb-4">
                          "{testimonial.text}"
                        </p>
                        <div>
                          <h4 className="font-semibold text-amor-verde-oscuro">
                            {testimonial.name}
                          </h4>
                          <p className="text-amor-malva text-sm">
                            {testimonial.role}
                          </p>
                        </div>
                      </div>
          ...
          {/* Indicadores */}
          <div className="flex justify-center mt-6">{renderDots()}</div>
        </div>
      </div>
    </section>
  );
